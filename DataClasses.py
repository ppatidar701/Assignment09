...
# PPatidar,12/10/2019, Modified script (more detail below)
# ---------------------------------------------------------- #
...
class Employee(Person):  # Inherits from Person
    ...
    changelog: (When,Who,What)
        RRoot,1.1.2030,Created Class
        KBosworth,12/3/2019,Fixed typo @employee_id.setter (changed self.__last_name = value to self.__employee_id = value)
    """
